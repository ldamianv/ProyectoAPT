(function() {
  const sectionsData = {
    ...
    so: [
      ...
      { title: "Horario", desc: "Programa el rol de turnos de tu equipo.", img: "Horariox.jpg", link: "https://docs.google.com/spreadsheets/d/1BDxQgeC_EvCosqG-UfWPszAYeWd6tilewucXXnaZhOM/edit?usp=sharing" }
    ],
    "reportes-generales": [
    ...
    tpm: {
      ...
      "instructivos": [
        { title: "Instructivos TPM", desc: "Consulta los manuales de TPM.", img: "instructivos.jpg", link: "https://drive.google.com/drive/folders/1rc-Sj9Cd8hQKb9x7fYGjwfLnG5h4E98D?usp=sharing" }
      ]
    }
  };
