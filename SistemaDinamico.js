(function() {
  const sectionsData = {
    ...
    "reportes-generales": [
      ...
      { title: "Reporte de Lento Movimiento", desc: "Identifica productos de lento movimiento.", img: "Movimientosx.jpeg", link: "#" },
      { title: "Sloting", desc: "Optimiza la ubicación de productos.", img: "Slotingx.jpeg", link: "#" },
