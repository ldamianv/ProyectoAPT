...
(function() {
  ...
  const sectionsData = {
    cp: [
      ...
      { title: "Control de Despachos", desc: "Registre el detalle de los despachos programados.", img: "Despachox.jpg", embedUrl: "https://docs.google.com/spreadsheets/d/1Wi28zNueNaSyhNhU8LE4q1c-H_GpvHeEs86LXOFFYa0/edit?usp=sharing" },
    ...
    "nuestra-gente": [
      ...
      { month: "Diciembre", name: "Jesus Llanos", date: "09-12" },
